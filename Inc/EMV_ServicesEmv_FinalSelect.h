...
#ifndef EMV_SERVICES_EMV_FINAL_SELECT_H_INCLUDED
#define EMV_SERVICES_EMV_FINAL_SELECT_H_INCLUDED
...
EMV_Status_t EMV_ServicesEmv_FinalSelect(EMV_Object_t EMV_object, TLV_TREE_NODE inputTlvTree,
			TLV_TREE_NODE *tagsKernelToAppli, TLV_TREE_NODE *tagsRequestedByKernel);

#endif // EMV_SERVICES_EMV_FINAL_SELECT_H_INCLUDED
